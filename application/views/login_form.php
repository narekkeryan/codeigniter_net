...
<body>
	...
	<div id="container">
		<h1>Welcome to CodeIgniter Tutorial Login Form!</h1>
		...
		<div id="body">
			...
			<form style="max-width: 215px;" action="#" method="post">
				...
				<input type="submit" name="submit" value="Sign in" class="btn btn-primary" /> <a style="float:right;margin-top:8px;" href="/codeigniter/index.php/register">Sign Up</a>
			</form>
